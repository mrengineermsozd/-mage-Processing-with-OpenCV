...
cap = cv2.VideoCapture('araclar.mp4')
...
while 1:
    ...
    for (x, y, w, h) in cars:
        ...
        cv2.putText(image, 'Car Detected', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1.3, (0, 255, 0), 1, cv2.LINE_AA)
        cv2.putText(image, 'FPS: {:.2f}'.format(fps), (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.7, (0, 255, 0), 1,
                    cv2.LINE_AA)
